    ...
    <div>
      ...
      <div className="container">
        <div className="row d-flex justify-content-center">
          <div className="col-8 ps-5  pt-3 border border-1 border-dark rounded-3">
            <div>
              <h4 className="">Getting started</h4>
            </div>
            <div className="mt-4">
              <p className="text-dark">What would you like to do?</p>
            </div>
            <div className="mt-4">
              <input type="radio" checked={true} />
              <label htmlFor="" className="ps-2" style={{ fontSize: "14px" }}>
                Create a new job post
              </label>
            </div>

            <div className="row p-5 ps-0 d-flex justify-content-center">
              <div className="col-12 rounded-4 ">
                <div className="row ">
                  {radiobuttons.map((radio, index) => (
                    <div
                      key={index}
                      className={`col-5  p-3 pt-0 rounded-3 box-hover-class1  ${
             ...
             <div className="row">
                <div className="col-12">
                     <div className="float-end ps-3"><button className="" disabled={selectedOption == null} onClick={()=>navigate(`/client/${id}/title`)}>Continue</button></div>
                     <div className="float-end "><Link>cancel</Link></div>
                </div>
             </div>
          </div>
        </div>
